...
\begin{description}
  ...
  \item[H3 (Hypotéza optimální ceny):] Optimální cenový bod (OPP) stanovený metodou Van Westendorp PSM pro 150g balení značky Berrie se bude nacházet minimálně 15\,\% pod aktuální tržní cenou hlavního konkurenta (Franui), což by podpořilo proveditelnost penetrační cenové strategie.
\end{description}
